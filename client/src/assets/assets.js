...
import mainbannersmall from "./mainbannersmall.jpg";
...
export const assets = {
   logo,arrow_right_icon_colored,add_icon,refresh_icon,product_list_icon,order_icon,
   search_icon,trust_icon,coin_icon,add_address_image,
   cartLogo,rupees,box_icon,
   profile,
   menu,
   arrowBlack,
   arrow,
