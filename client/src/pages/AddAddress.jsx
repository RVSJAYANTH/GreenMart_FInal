...
const InputField=({type,placeholder,name,handleChange,address})=>(
    ...
    focus:border-primary transition" type={type}
    placeholder={placeholder} onChange={handleChange} name={name} value={address[name]} />
)
            ...
            <div className="flex-1 max-w-md">
               <form onSubmit={onSubmitHandler} className="space-y-3 mt-6 text-sm">
                   <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                    <InputField handleChange={handleChange} address={address}
                                      name="zipcode" type="text" placeholder="Pin code"/>
                     <InputField handleChange={handleChange} address={address}
                    ...
                    <InputField handleChange={handleChange} address={address}
                     ...
                     uppercase">Save Address</button>
               </form>
            </div>
            <img className="md:mr-16 -mt-8 md:mt-0 w-160" src={assets.add_address_image} alt="Add Address"/>
        </div>
    </div>
  )
}
