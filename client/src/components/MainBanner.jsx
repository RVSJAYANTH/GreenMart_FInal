...
const MainBanner = () => {
  return (
    <div className="relative">
      <img src={assets.mainbanner} alt="mainbanner" className="w-full hidden md:block h-100" />
      <img src={assets.mainbannersmall} alt="mainbanner" className="w-full md:hidden" />
      ...
      <div className="absolute inset-0 flex flex-col items-center md:items-start justify-end md:justify-center
        ...
        <div className="flex items-center mt-6 font-medium">
          <Link to={"/products"} className="group flex items-center gap-2 px-7 md:px-9 py-3 bg-primary hover:bg-primary-dull transition rounded text-white cursor-pointer">
            Shop now
            <img src={assets.arrow} alt="arrow" className="md:hidden transition group-focus:translate-x-1 h-5" />
          </Link>

          <Link to={"/products"} className="group hidden md:flex items-center gap-2 px-9 py-3 cursor-pointer">
            Explore deals
            <img src={assets.arrowBlack} alt="arrow" className="transition group-hover:translate-x-1 h-5 w-5" />
          </Link>
        </div>
